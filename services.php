...
<body>
  ...
  <li class="list-group-item font-weight-bold">Online Process</li>
  <li class="list-group-item font-weight-bold">Product Choice</li>
  <li class="list-group-item font-weight-bold">Quick Delivery</li>
</ul>
  </div>
</div>
